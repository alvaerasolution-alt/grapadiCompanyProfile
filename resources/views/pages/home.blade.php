...
@section('content')
    ...
    <section class="bg-surface-light dark:bg-surface-dark py-20">
        <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div class="order-1 lg:order-1" data-animate="fade-in-left">
                <h3 class="text-xl lg:text-2xl font-bold text-gray-600 dark:text-gray-400 mb-2">
                    {{ $director['title'] }}
                </h3>
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold font-display text-navy-brand dark:text-white mb-4">
                    {{ $director['name'] }}
                </h2>
    ...
    {{-- Client Logos --}}
    {{-- Client Logos --}}
    <x-client-logos title="Trusted By" :brands="$trustedBrands" :speed="$logoScrollSpeed" :rows="2" />
    <x-client-logos title="Media Covered" :brands="$mediaBrands" :speed="$logoScrollSpeed" />
